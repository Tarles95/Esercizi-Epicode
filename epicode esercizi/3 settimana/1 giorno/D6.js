...
const risultatoS = sommaArray2(arrayNumerico);

console.log("La somma degli elementi nell'array è: " + risultatoS);
/* ESERCIZIO 6 (map)
...
const arrayNume = [1, 2, 3, 4, 5];
const n = 10;
const arrayIncrementato = incrementaArrayDiN(arrayNume, n);
...
*///contiamo le singole lunghezze dentro l'array

/* ESERCIZIO 8 (forEach o for)
  Scrivi una funzione per creare un array contenente tutti i valori DISPARI da 1 a 99.
*///ciclo for con tutti i numeri e pusho solo una condizione valida
...
*///accedere alla proprietà di title e pushare solo quella proprietà

/* ESERCIZIO 12 (filter)
  Scrivi una funzione per ottenere dall'array fornito solamente i film usciti nel millennio corrente.
*///controllo l'array e mi faccio dare solo i valori > 1999
...
*///passerò un valore in particolare 
